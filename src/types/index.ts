...
> = {
  anthropic: {
    ...
    models: [
      ...
      { id: "claude-opus-5", label: "Claude Opus 5 (质量最高)" },
  ...
  openai: {
    ...
    models: [
      { id: "gpt-5.4-mini", label: "GPT-5.4 mini (推荐，便宜)" },
      { id: "gpt-5.4", label: "GPT-5.4 (质量最高)" },
    ],
    free: false,
  },
  gemini: {
    ...
    models: [
      { id: "gemini-3.5-flash", label: "Gemini 3.5 Flash (推荐，最新)" },
      { id: "gemini-3.5-flash-lite", label: "Gemini 3.5 Flash Lite (最快最省)" },
      { id: "gemini-2.5-flash", label: "Gemini 2.5 Flash (免费额度大)" },
    ],
    free: true,
  },
  deepseek: {
    ...
    models: [
      { id: "deepseek-v4-flash", label: "DeepSeek V4 Flash (推荐，极低价)" },
      { id: "deepseek-v4-pro", label: "DeepSeek V4 Pro (推理增强)" },
      { id: "deepseek-v4-flash-vision-exp", label: "DeepSeek V4 Flash Vision (图像理解·Exp)" },
    ],
    free: false,
  },
};
